...
type ResPartner struct {
	...
	LatestFollowupDate                  *Time       `xmlrpc:"latest_followup_date,omitempty"`
	LatestFollowupLevelId               *Many2One   `xmlrpc:"latest_followup_level_id,omitempty"`
	LatestFollowupLevelIdWithoutLit     *Many2One   `xmlrpc:"latest_followup_level_id_without_lit,omitempty"`
	LatestFollowupSequence              *Int        `xmlrpc:"latest_followup_sequence,omitempty"`
	...
	PaymentAmountDue                    *Float      `xmlrpc:"payment_amount_due,omitempty"`
	PaymentAmountOverdue                *Float      `xmlrpc:"payment_amount_overdue,omitempty"`
	PaymentEarliestDueDate              *Time       `xmlrpc:"payment_earliest_due_date,omitempty"`
	PaymentNextAction                   *String     `xmlrpc:"payment_next_action,omitempty"`
	PaymentNextActionDate               *Time       `xmlrpc:"payment_next_action_date,omitempty"`
	PaymentNote                         *String     `xmlrpc:"payment_note,omitempty"`
